...
function WwcdStatsContent() {
    ...
    const wwcdTeamInfo = useMemo(() => {
        ...
        return { teamName: tName, players: top4.length > 0 ? top4 : Array.from({ length: config.playerCount }).map((_, i) => ({ playerKey: `dummy-${i}`, name: '...', teamName: '...', killNum: 0, damage: 0, survivalTime: 0, rank: 0 })), logoUrl: tLogo };
    ...
    return (
        <div style={{ width: '100vw', height: '100vh', backgroundColor: 'transparent', overflow: 'hidden' }}>
            ...
            >
                ...
                {/* Header: Cinematic Reveal - Unified and Non-Overlapping */}
                {config.showHeader && (
                <div
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-6xl font-black text-white uppercase tracking-tighter italic leading-none drop-shadow-premium">
                            {wwcdTeamInfo.teamName.replace(/^scout\s+/i, '')}
                        </span>
                ...
                {/* Team Showcase Area - Vertical List Layout (Matching MVP sample) */}
                <div 
                ...
                >
                        {wwcdTeamInfo.players.map((player, idx) => (
                            ...
                            >
                                {/* Portrait Container - DEFINITIVE CROP FIX */}
                                ...
                                {/* Identity Section - White Background with Pattern */}
                                <div className="flex-1 px-14 flex flex-col justify-center h-full relative z-10 overflow-hidden bg-white" 
                                    ...
                                    <div className="flex flex-col relative z-20">
                                        ...
                                        <p className="text-xl font-black tracking-[0.2em] uppercase opacity-70 mt-1" style={{ color: config.teamNameColor || '#1e293b' }}>{wwcdTeamInfo.teamName || '...'}</p>
                                    </div>
                                    <div className="absolute right-0 top-0 h-full w-2 bg-theme-primary opacity-20" style={{ backgroundColor: theme.primary }} />
                                </div>

                                {/* Stats Block - Green Background */}
